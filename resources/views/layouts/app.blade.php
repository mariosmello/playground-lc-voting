                    ...
                    @else
                        <div class="my-6 text-center">
                            ...
                            <a href="{{route('register')}}"
                               class="inline-block justify-center w-1/2 h-11 text-xs bg-gray-200 text-black font-semibold
                               rounded-xl border border-gray-200 hover:bg-gray-hover transition duration-150 ease-in
                               px-6 py-3 mt-4">
